$(document).ready(function() {
    ...
    $("#bidUpload").fileapi({
        ...
        onComplete: function(a, b) { 
            ...
            if( b.files[0].size > 104857600) {
            ...
            else if($.inArray(b.files[0].type,['image/jpg','image/png','image/gif','image/jpeg','video/mp4','video/quicktime','video/mpeg','video/flv']) == -1 ) {
                ...
                if ($.inArray(fileExtension, img) !== -1) { 
                    ...
                    $('.profile-box .upload-image').prepend(
                        '<video id="example_video_1" class="bid-video video-js vjs-sublime-skin vjs-big-play-centered" controls preload="auto" height="105" width="180" poster="http://www.followback.com/assets/images/overlay.png" style="margin-left:auto;margin-right:auto;">' +
                            '<source src="'+img_or_video+'">'+
                        '</video>');
