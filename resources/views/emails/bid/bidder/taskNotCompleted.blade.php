...
@section('content')
	...
	<p>We have just been notified from <strong>{{$bidderUsername}}</strong> that the social task <span style="background-color: #fffc00;"> <strong>{{$bidinstruction}}</strong> </span> has still not been completed.</p>
