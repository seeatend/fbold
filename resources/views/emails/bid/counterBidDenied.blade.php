...
<p>Counter bid denied</p>
		<p>
			The counter offer you placed for your <b>{{$bid['username']}}</b> <b>{{ucfirst($bid['service'])}}</b> account and <b>{{$bidDescription}}</b> (<b>${{$bid['offer_price']}}</b>) created initially by {{$bidderUsername}} was denied.
		</p>
