...
<div class="row">
	<div class="col-xs-12 padding-20">
		<?php echo Form::open(['route'=>'admin_most_search_user','method'=>'GET']); ?>
	...
	<div class="row">
		<div class="col-xs-12 mlr30">
			...
			@if($results['valid'])
					...
					<?php echo Form::open(['route'=>'admin_post_most_search_user', 'class'=> 'post_most_search_user']); ?>
					...
					<div class="admin_most_user_list_and_add_button_conainer">
						...
						<div class="most_user_add_button_container">
							...
							<button type="button" class="add_most_search_user btn btn-primary <?php echo $extClass; ?>" data-id="{{$result['identifier']}}"  data-type="{{ $type }} " data-image="{{ $result['avatar'] }}" data-name="{{$result['username'] }}">Add </button>
						</div>
					</div>
				@endforeach
				<?php echo Form::close(); ?>
...
$(document).ready(function() {
	...
	$('button.add_most_search_user').on('click', function() {
		var $this = $(this),
		type = $(this).attr('data-type'),
		image = $(this).attr('data-image'),
		name = $(this).attr('data-name'),
		identifier = $(this).attr('data-id'),
		url = $('.post_most_search_user').attr( "action" );
